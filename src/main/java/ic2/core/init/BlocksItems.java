...
public class BlocksItems {
   ...
   private static void initItems() {
      ...
      Ic2Items.woodrotor = new ItemStack(new ItemWindRotor(InternalName.itemwoodrotor, 5+EventConfig.additionalWindRotorRadius, 10800, 0.25F, 10, 60, new ResourceLocation(IC2.textureDomain, "textures/items/rotors/rotorWoodmodel.png")));
      Ic2Items.ironrotor = new ItemStack(new ItemWindRotor(InternalName.itemironrotor, 7+EventConfig.additionalWindRotorRadius, 86400, 0.5F, 14, 75, new ResourceLocation(IC2.textureDomain, "textures/items/rotors/rotorIronmodel.png")));
      Ic2Items.steelrotor = new ItemStack(new ItemWindRotor(InternalName.itemsteelrotor, 9+EventConfig.additionalWindRotorRadius, 172800, 0.75F, 17, 90, new ResourceLocation(IC2.textureDomain, "textures/items/rotors/rotorSteelmodel.png")));
      Ic2Items.carbonrotor = new ItemStack(new ItemWindRotor(InternalName.itemwcarbonrotor, 11+EventConfig.additionalWindRotorRadius, 604800, 1.0F, 20, 110, new ResourceLocation(IC2.textureDomain, "textures/items/rotors/rotorCarbonmodel.png")));
